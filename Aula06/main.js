...
/* bodyReference.innerHTML  += '<h2>Olá,  você tem</h2>' */
//VAI GERAR O CONTEUDO NO FINAL DO HTML
//SEM O + ELE VAI APAGAR TODO O HTML E MANTER SOMENTE O TEXTO
...
for (let post of posts) {
    ...
    mainContentReference.innerHTML += ` <div class="item">
   <img src="${post.imagem}">
   <h2>${post.titulo}</h2>
   <p>${post.texto}</p>
   </div>`
